...
import { Search, Tag, TrendingDown, Star, MapPin, Plus, Clock, Percent } from 'lucide-react';
import { useToast } from '@/hooks/use-toast';
import { apiRequest } from '@/lib/queryClient';

import type { User, Recommendation } from '@/lib/types';
    ...
    <div className="max-w-md mx-auto bg-white min-h-screen flex flex-col">
      ...
      <main className="flex-1 overflow-y-auto">
        ...
        <div className="px-4 pt-6 pb-4">
          <h1 className="text-2xl font-bold text-gray-900 mb-2">Deals & Recommendations</h1>
          <p className="text-sm text-gray-600">Find the best prices and personalized suggestions</p>
        </div>
        ...
        <div className="px-4 mb-4">
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            <TabsList className="grid w-full grid-cols-2">
              <TabsTrigger value="deals">Store Deals</TabsTrigger>
